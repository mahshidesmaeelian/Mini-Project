...
class Clip(Media):
    def __init__(self , media_pack):
        ...
        self.concept = media_pack[7]
        self.singer = media_pack[8]


    def edit_clips_info(self):
        print('1-id , 2-name , 3-category , 4-imdb rate , 5-url , 6-duration , 7-casts , 8-concept , 9-singer')
        ...
        if choise == 1:
            ...
            self.singer = user_replacement_input
        else:
