...
class Movie(Media):
    def __init__(self , media_pack):
        ...
        self.genre = media_pack[7]


    def edit_movies_info(self):
        print('1-id , 2-name , 3-category , 4-imdb rate , 5-url , 6-duration , 7-casts , 8-genre')
        ...
        if choise == 1:
            ...
            self.genre = user_replacement_input
